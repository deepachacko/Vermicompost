namespace VermiCompost.Controllers {
    ...
    export class AccountController {
        ...
        constructor(private accountService: VermiCompost.Services.AccountService, private $location: ng.ILocationService) {
    ...
    angular.module('VermiCompost').controller('AccountController', AccountController);
